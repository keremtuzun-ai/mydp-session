...
| `/dashboard` | Next session, committee, upcoming tasks, attendance, quick links |
| `/sessions`, `/sessions/new`, `/sessions/[id]`, `/sessions/[id]/edit` | Weekly session archive, detail with committee blocks, tasks, feedback |
