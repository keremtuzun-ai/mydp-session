...
async function main() {
  ...
  const tasks: TablesInsert<"tasks">[] = [
    { title: "Submit position paper: Gulf of Guinea", description: "One page, France's perspective. Cite at least two UNSC resolutions.", assigned_to_profile_id: id("ayse"), assigned_committee_id: cid("unsc"), committee_label: "UNSC", session_id: sid(4), created_by: id("chair_unsc"), author_name: "Selin Arslan", due_at: iso(daysFromNow(2, 20)), priority: "high", status: "in_progress" },
    { title: "Submit position paper: Gulf of Guinea", description: "One page, Ghana's perspective.", assigned_to_profile_id: id("mehmet"), assigned_committee_id: cid("unsc"), committee_label: "UNSC", session_id: sid(4), created_by: id("chair_unsc"), author_name: "Selin Arslan", due_at: iso(daysFromNow(2, 20)), priority: "high", status: "submitted" },
    { title: "Submit position paper: Gulf of Guinea", description: "One page, Japan's perspective.", assigned_to_profile_id: id("can"), assigned_committee_id: cid("unsc"), committee_label: "UNSC", session_id: sid(4), created_by: id("chair_unsc"), author_name: "Selin Arslan", due_at: iso(daysFromNow(-3, 20)), priority: "high", status: "overdue" },
    { title: "Opening speech draft", description: "60 seconds, no more than 140 words.", assigned_to_profile_id: id("ayse"), assigned_committee_id: cid("unsc"), committee_label: "UNSC", session_id: sid(2), created_by: id("chair_unsc"), author_name: "Selin Arslan", due_at: iso(daysFromNow(-12, 18)), priority: "normal", status: "completed", reviewed_by: id("chair_unsc"), reviewed_at: iso(daysFromNow(-11)) },
    { title: "Research brief: antibiotic supply chains", description: "Summarise WHO's 2024 AWaRe classification in half a page.", assigned_to_profile_id: id("zeynep"), assigned_committee_id: cid("who"), committee_label: "WHO", session_id: sid(4), created_by: id("chair_who"), author_name: "Emre Yıldız", due_at: iso(daysFromNow(4, 17)), priority: "normal", status: "not_started" },
    { title: "Research brief: antibiotic supply chains", description: "Kenya's perspective.", assigned_to_profile_id: id("elif"), assigned_committee_id: cid("who"), committee_label: "WHO", session_id: sid(4), created_by: id("chair_who"), author_name: "Emre Yıldız", due_at: iso(daysFromNow(4, 17)), priority: "normal", status: "reviewed", reviewed_by: id("chair_who"), reviewed_at: iso(daysFromNow(-1)), review_note: "Good start. Add the AMR figures for Sub-Saharan Africa and resubmit." },
    { title: "Read the Rules of Procedure guide", description: "Chapters 1 to 3 before the next session.", assigned_role: "delegate", created_by: id("exec"), author_name: "Leyla Şahin", due_at: iso(daysFromNow(6, 12)), priority: "low", status: "not_started" },
    { title: "Prepare a 5-minute moderated caucus topic", description: "Every UNSC delegate brings one caucus topic and a speakers' list.", assigned_committee_id: cid("unsc"), committee_label: "UNSC", created_by: id("chair_unsc"), author_name: "Selin Arslan", due_at: iso(daysFromNow(6, 12)), priority: "normal", status: "not_started" },
    { title: "Print delegate placards", description: "Placards for all committees meeting next week.", assigned_role: "chair", created_by: id("exec"), author_name: "Leyla Şahin", due_at: iso(daysFromNow(5, 9)), priority: "urgent", status: "in_progress" },
    { title: "Crisis backstory memo: McNamara", description: "Half a page on your character's stance on the blockade.", assigned_to_profile_id: id("burak"), assigned_committee_id: cid("hcc-1962"), committee_label: "HCC", session_id: sid(6), created_by: id("chair_unsc"), author_name: "Selin Arslan", due_at: iso(daysFromNow(12, 18)), priority: "normal", status: "not_started" },
  ];
  ...
  const announcements: TablesInsert<"announcements">[] = [
    { title: "Welcome to the new MUN year", body: "Sessions run every Tuesday at 10:55 in 1S and 15:10 in the Library. Bring a notebook, your placard and a printed copy of the rules.", author_id: id("exec"), author_name: "Leyla Şahin", pinned: true },
    { title: "Position papers due before the clinic", body: "Every delegate in UNSC and WHO uploads a one-page position paper before the Position Paper Clinic. Use the template in Materials.", author_id: id("exec"), author_name: "Leyla Şahin", pinned: true, target_session_id: sid(4) },
    { title: "UNSC: speakers' list opens at 15:40", body: "Arrive five minutes early. Delegates of Ghana and Japan open the general speakers' list.", author_id: id("chair_unsc"), author_name: "Selin Arslan", pinned: false, target_committee_id: cid("unsc") },
    { title: "Chairs: placards and rules cards", body: "Collect placards from the Secretariat desk before your committee time.", author_id: id("exec"), author_name: "Leyla Şahin", pinned: false, target_role: "chair" },
    { title: "WHO: background guide updated", body: "Section 3 now covers the 2024 AWaRe classification. Reread before the next debate.", author_id: id("chair_who"), author_name: "Emre Yıldız", pinned: false, target_committee_id: cid("who") },
  ];
  {
