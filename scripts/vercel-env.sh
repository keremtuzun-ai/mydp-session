...
vars=(NEXT_PUBLIC_SUPABASE_URL NEXT_PUBLIC_SUPABASE_ANON_KEY SUPABASE_SERVICE_ROLE_KEY ALLOWED_SCHOOL_DOMAINS NEXT_PUBLIC_APP_NAME NEXT_PUBLIC_SCHOOL_NAME MAX_UPLOAD_BYTES NEXT_PUBLIC_SITE_URL NEXT_PUBLIC_TIMEZONE EXEC_INVITE_TOKEN)
for name in "${vars[@]}"; do
